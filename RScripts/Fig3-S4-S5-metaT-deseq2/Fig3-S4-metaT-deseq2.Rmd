...
heatmaply_cor(x = corr_table_short,
               colors = viridis)
ggsave("../Figures/Deseq2/VOC-gene-heatmap.png", dpi = 300, width = 4, height = 3)
...
ggsave("../Figures/Fig3-S4-S5-Deseq2/VOC-genes-all-times.png", dpi = 300, width = 3, height = 5)
```
...
p1 <- as.data.frame(res.T0) %>%
  ...
  theme(text = element_text(size = 12,
        ...
        axis.text.x = element_text(vjust = 1, hjust = 0.5, color = "black", size = 10),
        axis.text.y = element_text(color = "black", size = 10))
ggsave("../Figures/Fig3-S4-S5-Deseq2/Fig3-VOC-genes-T0.png", dpi = 300, width = 3, height = 5)
...
p2 <- as.data.frame(res.T6) %>%
  ...
  theme(text = element_text(size = 12,
        ...
        axis.text.x = element_text(vjust = 1, hjust = 0.5, color = "black", size = 10),
        axis.text.y = element_text(color = "black", size = 10))
ggsave("../Figures/Fig3-S4-S5-Deseq2/Fig3-VOC-genes-T6.png", dpi = 300, width = 3, height = 5)
```
###Time 48 hr
```{r}
#time 48
p3 <- as.data.frame(res.t48) %>%
  ...
  theme(text = element_text(size = 12,
        ...
        axis.text.x = element_text(vjust = 1, hjust = 0.5, color = "black", size = 10),
        axis.text.y = element_text(color = "black", size = 10))
ggsave("../Figures/Fig3-S4-S5-Deseq2/Fig3-VOC-genes-T48.png", dpi = 300, width = 3, height = 5)
```
...
p4 <- as.data.frame(res.d.6.0) %>%
  ...
  theme(text = element_text(size = 12,
        ...
        axis.text.x = element_text(vjust = 1, hjust = 0.5, color = "black", size = 10),
        axis.text.y = element_text(color = "black", size = 10))
ggsave("../Figures/Fig3-S4-S5-Deseq2/FigS4-VOC-genes-dr-6-0.png", dpi = 300, width = 3, height = 5)
```
###Drought 48 vs 0hr
```{r}
p5 <- as.data.frame(res.d.48.0) %>%
  rownames_to_column(var = "KO") %>%
  merge(.,interest , by = "KO") %>%
  filter(Priority == "yes") %>%
  mutate(Significance =
 ...
 scale_color_manual (values = c("red" ,"blue"),
  ...
  theme(text = element_text(size = 12,
        ...
        axis.text.x = element_text(vjust = 1, hjust = 0.5, color = "black", size = 10),
        axis.text.y = element_text(color = "black", size = 10))
ggsave("../Figures/Fig3-S4-S5-Deseq2/FigS4-VOC-genes-dr-48-0.png", dpi = 300, width = 3, height = 5)
```

###PreDrought 6 vs 0hr
```{r}
#time 6 vs 0 drought
p6 <- as.data.frame(res.pd.6.0) %>%
  rownames_to_column(var = "KO") %>%
  merge(.,interest , by = "KO") %>%
  filter(Priority == "yes") %>%
  mutate(Significance =
 ...
 scale_color_manual (values = c("red" ,"blue"),
  ...
  theme(text = element_text(size = 12,
        ...
        axis.text.x = element_text(vjust = 1, hjust = 0.5, color = "black", size = 10),
        axis.text.y = element_text(color = "black", size = 10))
ggsave("../Figures/Fig3-S4-S5-Deseq2/FigS4-VOC-genes-pd-6-0.png", dpi = 300, width = 3, height = 5)
```
###PreDrought 48 vs 0hr
```{r}
p7 <- as.data.frame(res.pd.48.0) %>%
  rownames_to_column(var = "KO") %>%
  merge(.,interest , by = "KO") %>%
  filter(Priority == "yes") %>%
  mutate(Significance =
  ...
  theme(text = element_text(size = 12,
        ...
        axis.text.x = element_text(vjust = 1, hjust = 0.5, color = "black", size = 10),
        axis.text.y = element_text(color = "black", size = 10))
ggsave("../Figures/Fig3-S4-S5-Deseq2/FigS4-VOC-genes-pd-48-0.png", dpi = 300, width = 3, height = 5)
```
...
filename=paste("../Figures/Fig3-S4-S5-Deseq2/FigS5-K00156.png", sep = "")
...
filename=paste("../Figures/Fig3-S4-S5-Deseq2/FigS5-K00158.png", sep = "")
png(filename ,width=6, height=5, unit='in', res = 1000)
ggplot(d, aes(x=Time, y=count, fill = Condition)) + 
  geom_point() + geom_boxplot() + 
  facet_grid(~Condition) +
...
filename=paste("../Figures/Fig3-S4-S5-Deseq2/FigS5-K01067.png", sep = "")
png(filename ,width=6, height=5, unit='in', res = 1000)
ggplot(d, aes(x=Time, y=count, fill = Condition)) + 
  geom_point() + geom_boxplot() + 
  facet_grid(~Condition) +
...
filename=paste("../Figures/Fig3-S4-S5-Deseq2/FigS5-K01026.png", sep = "")
png(filename ,width=6, height=5, unit='in', res = 1000)
ggplot(d, aes(x=Time, y=count, fill = Condition)) + 
  geom_point() + geom_boxplot() + 
  facet_grid(~Condition) +
...
filename=paste("../Figures/Fig3-S4-S5-Deseq2/FigS5-K18118.png", sep = "")
png(filename ,width=6, height=5, unit='in', res = 1000)
ggplot(d, aes(x=Time, y=count, fill = Condition)) + 
  geom_point() + geom_boxplot() + 
  facet_grid(~Condition) +
...
filename=paste("../Figures/Fig3-S4-S5-Deseq2/FigS5-K01895.png", sep = "")
png(filename ,width=6, height=5, unit='in', res = 1000)
ggplot(d, aes(x=Time, y=count, fill = Condition)) + 
  geom_point() + geom_boxplot() + 
  facet_grid(~Condition) +
...
filename=paste("../Figures/Fig3-S4-S5-Deseq2/FigS5-K00925.png", sep = "")
png(filename ,width=6, height=5, unit='in', res = 1000)
ggplot(d, aes(x=Time, y=count, fill = Condition)) + 
  geom_point() + geom_boxplot() + 
  facet_grid(~Condition) +
...
filename=paste("../Figures/Fig3-S4-S5-Deseq2/FigS5-K01512.png", sep = "")
png(filename ,width=6, height=5, unit='in', res = 1000)
ggplot(d, aes(x=Time, y=count, fill = Condition)) + 
  geom_point() + geom_boxplot() + 
  facet_grid(~Condition) +
...
filename=paste("../Figures/Fig3-S4-S5-Deseq2/FigS5-K01574.png", sep = "")
png(filename ,width=6, height=5, unit='in', res = 1000)
ggplot(d, aes(x=Time, y=count, fill = Condition)) + 
  geom_point() + geom_boxplot() + 
  facet_grid(~Condition) +
...
filename=paste("../Figures/Fig3-S4-S5-Deseq2/FigS5-K18382.png", sep = "")
png(filename ,width=6, height=5, unit='in', res = 1000)
ggplot(d, aes(x=Time, y=count, fill = Condition)) + 
  geom_point() + geom_boxplot() + 
  facet_grid(~Condition) +
...
filename=paste("../Figures/Fig3-S4-S5-Deseq2/FigS5-K18371.png", sep = "")
png(filename ,width=6, height=5, unit='in', res = 1000)
ggplot(d, aes(x=Time, y=count, fill = Condition)) + 
  geom_point() + geom_boxplot() + 
  facet_grid(~Condition) +
...
filename=paste("../Figures/Fig3-S4-S5-Deseq2/FigS5-K10854.png", sep = "")
png(filename ,width=6, height=5, unit='in', res = 1000)
ggplot(d, aes(x=Time, y=count, fill = Condition)) + 
  geom_point() + geom_boxplot() + 
  facet_grid(~Condition) +
...
filename=paste("../Figures/Fig3-S4-S5-Deseq2/FigS5-K10855.png", sep = "")
png(filename ,width=6, height=5, unit='in', res = 1000)
ggplot(d, aes(x=Time, y=count, fill = Condition)) + 
  geom_point() + geom_boxplot() + 
  facet_grid(~Condition) +
...
filename=paste("../Figures/Fig3-S4-S5-Deseq2/FigS5-K10856.png", sep = "")
png(filename ,width=6, height=5, unit='in', res = 1000)
ggplot(d, aes(x=Time, y=count, fill = Condition)) + 
  geom_point() + geom_boxplot() + 
  facet_grid(~Condition) +
...
##playing around
d <- plotCounts(dds, gene="KO:K00399", intgroup=c("Condition", "Time"), 
                returnData=TRUE)

filename=paste("../Figures/Fig3-S4-S5-Deseq2/methanogenesis-K10399.png", sep = "")
png(filename ,width=6, height=5, unit='in', res = 1000)
ggplot(d, aes(x=Time, y=count, fill = Condition)) + 
  geom_point() + geom_boxplot() + 
  facet_grid(~Condition) +
  ...
  scale_fill_manual (values = col_list2) +
  #scale_x_discrete(labels = c("0", "6", "48")) +
  labs(title = "K00399-methanogensis") +
  theme_bw() +
  theme(text = element_text(size = 16,
                            family = "Arial",
                            color = "black"),
