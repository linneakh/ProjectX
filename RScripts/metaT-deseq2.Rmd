...
p4 <- as.data.frame(res.d.6.0) %>%
  ...
  theme(text = element_text(size = 12,
        ...
        axis.text.x = element_text(vjust = 1, hjust = 0.5, color = "black", size = 10),
        axis.text.y = element_text(color = "black", size = 10))
ggsave("../Figures/Deseq2/VOC-genes-dr-6-0.png", dpi = 300, width = 3, height = 5)
```
###Drought 48 vs 0hr
```{r}
p5 <- as.data.frame(res.d.48.0) %>%
 ...
 scale_color_manual (values = c("red" ,"blue"),
  ...
  theme(text = element_text(size = 12,
        ...
        axis.text.x = element_text(vjust = 1, hjust = 0.5, color = "black", size = 10),
        axis.text.y = element_text(color = "black", size = 10))
ggsave("../Figures/Deseq2/VOC-genes-dr-48-0.png", dpi = 300, width = 3, height = 5)
```
...
p6 <- as.data.frame(res.pd.6.0) %>%
 ...
 scale_color_manual (values = c("red" ,"blue"),
  ...
  theme(text = element_text(size = 12,
        ...
        axis.text.x = element_text(vjust = 1, hjust = 0.5, color = "black", size = 10),
        axis.text.y = element_text(color = "black", size = 10))
ggsave("../Figures/Deseq2/VOC-genes-pd-6-0.png", dpi = 300, width = 3, height = 5)
```
...
p7 <- as.data.frame(res.pd.48.0) %>%
  ...
  theme(text = element_text(size = 12,
        ...
        axis.text.x = element_text(vjust = 1, hjust = 0.5, color = "black", size = 10),
        axis.text.y = element_text(color = "black", size = 10))
ggsave("../Figures/Deseq2/VOC-genes-pd-48-0.png", dpi = 300, width = 3, height = 5)
```
...
filename=paste("../Figures/Deseq2/K00156.png", sep = "")
...
filename=paste("../Figures/Deseq2/K00158.png", sep = "")
png(filename ,width=6, height=5, unit='in', res = 1000)
ggplot(d, aes(x=Time, y=count, fill = Condition)) + 
  geom_point() + geom_boxplot() + 
  facet_grid(~Condition) +
...
filename=paste("../Figures/Deseq2/K01067.png", sep = "")
png(filename ,width=6, height=5, unit='in', res = 1000)
ggplot(d, aes(x=Time, y=count, fill = Condition)) + 
  geom_point() + geom_boxplot() + 
  facet_grid(~Condition) +
...
filename=paste("../Figures/Deseq2/K01026.png", sep = "")
png(filename ,width=6, height=5, unit='in', res = 1000)
ggplot(d, aes(x=Time, y=count, fill = Condition)) + 
  geom_point() + geom_boxplot() + 
  facet_grid(~Condition) +
...
filename=paste("../Figures/Deseq2/K18118.png", sep = "")
png(filename ,width=6, height=5, unit='in', res = 1000)
ggplot(d, aes(x=Time, y=count, fill = Condition)) + 
  geom_point() + geom_boxplot() + 
  facet_grid(~Condition) +
...
filename=paste("../Figures/Deseq2/K01895.png", sep = "")
png(filename ,width=6, height=5, unit='in', res = 1000)
ggplot(d, aes(x=Time, y=count, fill = Condition)) + 
  geom_point() + geom_boxplot() + 
  facet_grid(~Condition) +
...
filename=paste("../Figures/Deseq2/K00925.png", sep = "")
png(filename ,width=6, height=5, unit='in', res = 1000)
ggplot(d, aes(x=Time, y=count, fill = Condition)) + 
  geom_point() + geom_boxplot() + 
  facet_grid(~Condition) +
...
filename=paste("../Figures/Deseq2/K01512.png", sep = "")
png(filename ,width=6, height=5, unit='in', res = 1000)
ggplot(d, aes(x=Time, y=count, fill = Condition)) + 
  geom_point() + geom_boxplot() + 
  facet_grid(~Condition) +
...
filename=paste("../Figures/Deseq2/K01574.png", sep = "")
png(filename ,width=6, height=5, unit='in', res = 1000)
ggplot(d, aes(x=Time, y=count, fill = Condition)) + 
  geom_point() + geom_boxplot() + 
  facet_grid(~Condition) +
...
filename=paste("../Figures/Deseq2/K18382.png", sep = "")
png(filename ,width=6, height=5, unit='in', res = 1000)
ggplot(d, aes(x=Time, y=count, fill = Condition)) + 
  geom_point() + geom_boxplot() + 
  facet_grid(~Condition) +
...
filename=paste("../Figures/Deseq2/K18371.png", sep = "")
png(filename ,width=6, height=5, unit='in', res = 1000)
ggplot(d, aes(x=Time, y=count, fill = Condition)) + 
  geom_point() + geom_boxplot() + 
  facet_grid(~Condition) +
...
filename=paste("../Figures/Deseq2/K10854.png", sep = "")
png(filename ,width=6, height=5, unit='in', res = 1000)
ggplot(d, aes(x=Time, y=count, fill = Condition)) + 
  geom_point() + geom_boxplot() + 
  facet_grid(~Condition) +
...
filename=paste("../Figures/Deseq2/K10855.png", sep = "")
png(filename ,width=6, height=5, unit='in', res = 1000)
ggplot(d, aes(x=Time, y=count, fill = Condition)) + 
  geom_point() + geom_boxplot() + 
  facet_grid(~Condition) +
...
filename=paste("../Figures/Deseq2/K10856.png", sep = "")
png(filename ,width=6, height=5, unit='in', res = 1000)
ggplot(d, aes(x=Time, y=count, fill = Condition)) + 
  geom_point() + geom_boxplot() + 
  facet_grid(~Condition) +
