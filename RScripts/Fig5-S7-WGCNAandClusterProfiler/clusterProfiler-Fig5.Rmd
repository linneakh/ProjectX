...
p11 <- cnetplot(k.black,
  ...
  scale_color_manual(values = c("black", "darkgrey")) +
  guides(color = FALSE)
filename <- paste0("../Figures/Fig5-S7-WGCNA-ClusterProfiler/ClusterProfiler/net-plot-black-oeg-retry.png")
ggsave(filename,width=10,height=5,dpi=1000,p11)

p12 <- cnetplot(k.brown, cex_label_gene = 0.75, cex_label_category = 1.5) +
  scale_color_manual(values = c("brown", "#D98880")) +
  guides(color = FALSE)
filename <- paste0("../Figures/Fig5-S7-WGCNA-ClusterProfiler/ClusterProfiler/Fig5-net-plot-brown-oeg.png")
...
p15 <- cnetplot(k.red,
  ...
  scale_color_manual(values = c("red", "#F3AE9A")) +
  guides(color = FALSE)
filename <- paste0("../Figures/Fig5-S7-WGCNA-ClusterProfiler/ClusterProfiler/net-plot-red-oeg-retry.png")
...
p16 <- cnetplot(k.green, showCategory = c("Oxidative phosphorylation", "Ribosome", "Carbon metabolism"),
  ...
  guides(color = FALSE)
filename <- paste0("../Figures/Fig5-S7-WGCNA-ClusterProfiler/ClusterProfiler/Fig5-net-plot-green-oeg.png")
...
p16 <- cnetplot(k.pink, showCategory = c("Alanine, aspartate and glutamate metabolism", "Starch and sucrose metabolism",
  ...
  guides(color = FALSE)
filename <- paste0("../Figures/Fig5-S7-WGCNA-ClusterProfiler/ClusterProfiler/Fig5-net-plot-pink-oeg.png")
ggsave(filename,width=10,height=5,dpi=1000,p16)
...
p17 <- cnetplot(k.magenta,
  ...
  scale_color_manual(values = c("magenta", "#EFBFF2")) +
  guides(color = FALSE)
filename <- paste0("../Figures/Fig5-S7-WGCNA-ClusterProfiler/ClusterProfiler/Fig5-net-plot-magenta-oeg.png")
