...
p11 <- cnetplot(k.black,
                cex_label_gene = 0.75, cex_label_category = 1.5) +
  scale_color_manual(values = c("black", "darkgrey")) +
  guides(color = FALSE)
filename <- paste0("../Figures/ClusterProfiler/net-plot-black-oeg-retry.png")
ggsave(filename,width=10,height=5,dpi=1000,p11)

p12 <- cnetplot(k.brown, cex_label_gene = 0.75, cex_label_category = 1.5) +
  scale_color_manual(values = c("brown", "#D98880")) +
  guides(color = FALSE)
filename <- paste0("../Figures/ClusterProfiler/net-plot-brown-oeg-retry.png")
ggsave(filename,width=10,height=5,dpi=1000,p12)
...
p15 <- cnetplot(k.red,
  ...
  scale_color_manual(values = c("red", "#F3AE9A")) +
  guides(color = FALSE)
filename <- paste0("../Figures/ClusterProfiler/net-plot-red-oeg-retry.png")
ggsave(filename,width=10,height=5,dpi=1000,p15)
...
p16 <- cnetplot(k.green, showCategory = c("Oxidative phosphorylation", "Ribosome", "Carbon metabolism"),
  ...
  guides(color = FALSE)
filename <- paste0("../Figures/ClusterProfiler/net-plot-green-oeg-retry.png")
ggsave(filename,width=10,height=5,dpi=1000,p16)

p16 <- cnetplot(k.pink, showCategory = c("Alanine, aspartate and glutamate metabolism", "Starch and sucrose metabolism",
                                         "Ribosome", "Histodine metabolism"),
                cex_label_gene = 0.75, cex_label_category = 1.5) +
  scale_color_manual(values = c("pink4", "pink")) +
  guides(color = FALSE)
filename <- paste0("../Figures/ClusterProfiler/net-plot-pink-oeg-retry.png")
ggsave(filename,width=10,height=5,dpi=1000,p16)
...
p17 <- cnetplot(k.magenta,
  ...
  scale_color_manual(values = c("magenta", "#EFBFF2")) +
  guides(color = FALSE)
filename <- paste0("../Figures/ClusterProfiler/net-plot-magenta-oeg-retry.png")
ggsave(filename,width=10,height=5,dpi=1000,p17)

```

```{r}
pnew <- ggpubr::ggarrange(p15, p17, 
                  ncol = 2, nrow = 1, common.legend = TRUE, legend = "right")

pnew2 <-  ggpubr::ggarrange(p12, p13, 
                  ncol = 2, nrow = 1, common.legend = TRUE, legend = "right")

p <- ggpubr::ggarrange(pnew, pnew2, labels = c("A", "B"), 
