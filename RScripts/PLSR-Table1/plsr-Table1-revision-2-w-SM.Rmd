...
KO_VOC.t.f[,32] <- rownames(KO_VOC.t.f)
KO_VOC.t.f_new_id_w_full_name <- KO_VOC.t.f %>%
  mutate(Sample = case_when(
  startsWith(V32, "X3300044942") ~ "S3P4",
  startsWith(V32, "X3300044943") ~ "S3P4",
  startsWith(V32, "X3300044944") ~ "S3P4",
  startsWith(V32, "X3300044945") ~ "S3P4",
  startsWith(V32, "X3300045458") ~ "S1P5",
  startsWith(V32, "X3300045459") ~ "S1P5",
  startsWith(V32, "X3300045460") ~ "S1P5",
  startsWith(V32, "X3300045461") ~ "S2P4",
  startsWith(V32, "X3300045462") ~ "S2P4",
  startsWith(V32, "X3300045463") ~ "S2P4",
  startsWith(V32, "X3300045464") ~ "S2P4",
  startsWith(V32, "X3300045465") ~ "S2P4",
  startsWith(V32, "X3300045466") ~ "S2P6",
  startsWith(V32, "X3300045467") ~ "S2P6",
  startsWith(V32, "X3300045468") ~ "S2P6",
  startsWith(V32, "X3300045469") ~ "S2P6",
  startsWith(V32, "X3300045470") ~ "S2P6",
  startsWith(V32, "X3300045471") ~ "S3P5",
  startsWith(V32, "X3300045472") ~ "S3P5",
  startsWith(V32, "X3300045473") ~ "S2P6",
  startsWith(V32, "X3300048051") ~ "S1P5",
  startsWith(V32, "X3300048052") ~ "S3P5",
  startsWith(V32, "X3300048053") ~ "S3P5",
  startsWith(V32, "X3300048054") ~ "S3P5",
  startsWith(V32, "X3300048092") ~ "S1P1",
  startsWith(V32, "X3300048093") ~ "S1P1",
  startsWith(V32, "X3300048094") ~ "S1P1",
  startsWith(V32, "X3300048095") ~ "S1P1",
  startsWith(V32, "X3300048096") ~ "S1P1",
  startsWith(V32, "X3300048099") ~ "S1P5",
  startsWith(V32, "X3300048100") ~ "S1P5",
  startsWith(V32, "X3300049511") ~ "S2P4",
  startsWith(V32, "X3300049512") ~ "S3P4",
  startsWith(V32, "X3300049557") ~ "S3P4",
  startsWith(V32, "X3300049628") ~ "S3P5"
  )) %>%
  mutate(Time.d = case_when(
    endsWith(V32, "6hr") ~ "6",
    endsWith(V32, "0hr") ~ "0",
    endsWith(V32, "48hr") ~ "48",
    endsWith(V32, "48_hr") ~ "48"
  )) %>%
  mutate(Condition = case_when(
    grepl("PreDrought", V32) ~ "Pre-Drought",
    grepl("Drought", V32) ~ "Drought",
    grepl("Pre_drought", V32) ~ "Pre-Drought"
  )) %>%
  mutate(Site = case_when(
    grepl("Site1", V32) ~ "Site1",
    grepl("Site2", V32) ~ "Site2",
    grepl("Site3", V32) ~ "Site3"
  )) 
...
trait_data_for_WGCNA <- merged_subset_physico_full_names[,c(36,37,39,41, 43,44,45)]
trait_data_for_WGCNA$SampleID <- trait_data_for_WGCNA[,1]
trait_data_for_WGCNA$V32 <- NULL
