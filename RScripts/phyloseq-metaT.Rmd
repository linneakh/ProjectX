...
```{r import_data}
#import biom table
otu=read.table('feature-table.csv',sep = ",", header = TRUE)
...
map = read.table('metadata.csv',sep = ",", header = TRUE)
row.names(map) <- map[,1]
map$SampleID <- NULL
...
#import taxnomy
taxa.frame = read.csv(file="metaT-taxonomy.csv", header = TRUE, sep=",", 
