...
df.0 <- read.csv(file="./Data/PCA/Drought_vs_predrought_metaT_missing_1_no_feature.csv", header = TRUE, blank.lines.skip = TRUE)
...
filename <- paste0("./Figures/PCA_genomic/PCA_screeplot-log.png")
...
filename <- paste0("./Figures/PCA_genomic/PCA_cumulative_var-log.png")
...
pca_plot
filename <- paste0("./Figures/PCA_genomic/metaT-PCA-site.png")
ggsave(filename,units=c('in'),width=w,height=h,dpi=res,pca_plot)
...
scree <- make_screeplot(eigen, dimensions) + ggtitle('Scree plot, PCA Class')
filename <- paste0("./Figures/PCA_genomic/PCA_screeplot-log-metaG.png")
ggsave(filename,units=c('in'),width=w,height=h,dpi=res,scree)
cumvar <-  make_cumvar(eigen, dimensions) + ggtitle('Cumulative variance plot, PCA Class')
filename <- paste0("./Figures/PCA_genomic/PCA_cumulative_var-log-metaG.png")
ggsave(filename,units=c('in'),width=w,height=h,dpi=res,cumvar)
...
pca_plot <-  #pca_biplot +
  ...
  theme( legend.text = element_text(size=size+3, face="bold"),
         ...
         plot.title = element_text(size=size+3,face="bold")) 
pca_plot
filename <- paste0("./Figures/PCA_genomic/metaG-PCA-condition.png")
ggsave(filename,units=c('in'),width=w,height=h,dpi=res,pca_plot)
...
pca_plot <-  #pca_biplot +
  ...
  theme( legend.text = element_text(size=size, face="bold"),
         ...
         plot.title = element_text(size=size,face="bold")) 
pca_plot
filename <- paste0("./Figures/PCA_genomic/metaG-PCA-site.png")
ggsave(filename,units=c('in'),width=w,height=h,dpi=res,pca_plot)
