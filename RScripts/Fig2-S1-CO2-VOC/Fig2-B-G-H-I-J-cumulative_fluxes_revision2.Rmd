...
plot <- AUC.aton %>%
  ...
  theme(text = element_text(size = 14,
        ...
        legend.title = element_blank())
plot
ggsave("../../Figures/Fig2-S2-CO2-VOCs/corrected_voc_data/Fig2H-total-C-acetone-flux.pdf",units=c('in'),width=4, height = 4,dpi=300,plot)
...
plot.Diac <- AUC.Diac %>%
 mutate(Cond=factor(Cond, levels = c("Pre_Drought", "Drought"))) %>%
  ...
  theme(text = element_text(size = 14,
        ...
        legend.title = element_blank())
plot.Diac
ggsave("../../Figures/Fig2-S2-CO2-VOCs/corrected_voc_data/Fig2F-total-C-diacetyl-flux-c1-and-c2.pdf",
       units=c('in'),width=4, height =4,dpi=300,plot.Diac)
