...
write.csv(AUC, "../../Output/CO2-VOCs/AUC/CO2-auc.csv")
...
plot
ggsave("../../Figures/Fig2-S2-CO2-VOCs/Fig2b-total-C-CO2-flux.pdf",units=c('in'),width=4, height = 4,dpi=300,plot)
...
plot <- AUC %>%
  ...
  theme(text = element_text(size = 12,
        ...
        legend.title = element_blank())
plot
#ggsave("../../Figures/Fig2-S2-CO2-VOCs/total-C-CO2-per-flux.png",units=c('in'),width=6, height = 4,dpi=300,plot)
...
write.csv(AUC.aton, "../../Output/CO2-VOCs/AUC/acetone-auc.csv")
...
# plot cummalative flux of 13C pyruvate (C2 only because only C2 showed enrichment)
plot <- AUC.aton %>%
  filter(Pyr == "C2") %>%
  mutate(Cond=factor(Cond, levels = c("Pre_Drought", "Drought"))) %>%
  ggplot(aes(x= Cond, y = umol, fill = Cond)) +
  ...
  theme(text = element_text(size = 14,
        ...
        legend.title = element_blank())
plot
ggsave("../../Figures/Fig2-S2-CO2-VOCs/corrected_voc_data/Fig2H-total-C-acetone-flux.pdf",units=c('in'),width=2, height = 4,dpi=300,plot)
...
write.csv(AUC.Diac, "../../Output/CO2-VOCs/AUC/diacetyl-auc.csv")
...
# plot cummalative flux of 13C for C2 only (because only C2 showed enrichment)
plot.Diac <- AUC.Diac %>%
  filter(Pyr == "C2") %>%
 mutate(Cond=factor(Cond, levels = c("Pre_Drought", "Drought"))) %>%
  ggplot(aes(x= Cond, y = umol, fill = Cond)) +
  ...
  theme(text = element_text(size = 14,
        ...
        legend.title = element_blank())
plot.Diac
ggsave("../../Figures/Fig2-S2-CO2-VOCs/corrected_voc_data/Fig2I-total-C-diacetyl-flux-c2.pdf",
       units=c('in'),width=2, height =4,dpi=300,plot.Diac)
...
write.csv(AUC.acetate, "../../Output/CO2-VOCs/AUC/acetate-auc.csv")
...
plot <- AUC.acetate %>%
  ...
  theme(text = element_text(size = 14,
        ...
        legend.title = element_blank())
plot
ggsave("../../Figures/Fig2-S2-CO2-VOCs/corrected_voc_data/Fig2G-total-C-acetate-flux.pdf",units=c('in'),width=4, height = 4,dpi=300,plot)
...
pie.d
ggsave("../../Figures/Fig2-S1-CO2-VOCs/corrected_voc_data/Fig2J-pie_d_bio_tca.pdf",units=c('in'),width=3, height = 3,dpi=300,pie.d)
...
pie.p <- ggplot(summary.allocation.p.t, aes(x="", y=perc.alloc, fill =cat.alloc )) +
  ...
  theme(legend.title = element_blank())
pie.p
ggsave("../../Figures/Fig2-S1-CO2-VOCs/corrected_voc_data/Fig2J-pie_p_bio_tca.pdf",units=c('in'),width=3, height = 3,dpi=300,pie.p)
