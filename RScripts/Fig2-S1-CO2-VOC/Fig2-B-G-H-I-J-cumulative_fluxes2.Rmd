...
write.csv(data.13.P.long, "../../Output/CO2-VOCs/data.13.Plong.acetone.csv")
...
write.csv(df.p.0, "../../Output/CO2-VOCs/df.p.0.acetone.csv")

# erase rows with NA and name columns
df.p <- df.p.0 %>%
  dplyr::rename(Label = X1, Flux = X2, Time = X3) %>%
  filter(Label != "NA")
write.csv(df.p, "../../Output/CO2-VOCs/df.p.acetone.csv")
...
write.csv(df.p.f, "../../Output/CO2-VOCs/df.p.f.acetone.csv")
